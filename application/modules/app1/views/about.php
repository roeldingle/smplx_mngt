			<div class="contents">  <!-- start of content -->
				...
				<ul class="aboutus">
					<li>
						<a href=""><img src="<?php echo $assets_path;?>app1/images/about-biker.jpg"  width="450" height="299" alt="Bikers Club" title="Bikers Club"></a>
					</li>
					<li>
							<a href=""><img src="<?php echo $assets_path;?>app1/images/about-bikers.jpg" width="450" height="299" alt="Bikers Club" title="Bikers Club"></a>
					</li>
				</ul>	
