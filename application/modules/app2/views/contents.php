<div class="contents">  <!-- start of content -->
				...
				<div class="gallery">
					<ul>     
					     <?php for($i = 0 ; $i < 20;$i++):?>
						<li>
							<a href=""><img src="<?php echo base_url();?>assets/images/gallery-girls.jpg"  width="280" height="190" alt="Bikers Club" title="Bikers Club"></a>
						...
						<li>
							<a href=""><img src="<?php echo base_url();?>assets/images/gallery-family.jpg"  width="280" height="190" alt="Bikers Club" title="Bikers Club"></a>
						 ...
						 <li>
							<a href=""><img src="<?php echo base_url();?>assets/images/gallery-biker.jpg"  width="280" height="190" alt="Bikers Club" title="Bikers Club"></a>
						...
						<li>
							<a href=""><img src="<?php echo base_url();?>assets/images/gallery-biker2.jpg"  width="280" height="190" alt="Bikers Club" title="Bikers Club"></a>
						...
						<li>
							<a href=""><img src="<?php echo base_url();?>assets/images/gallery-family2.jpg"  width="280" height="190" alt="Bikers Club" title="Bikers Club"></a>
							<h4>Proin a nisi et turpis sagittis imperdiet in eget nibh nisi lectus ultricies</h4>
							<p>Mauris et turpis libero. Nam adipiscing nunc eu orci digniss.purus placerat. Nunc eleifend bibendum orci et placerat.</p>
						 </li>
						 <li>
							<a href=""><img src="<?php echo base_url();?>assets/images/gallery-boys.jpg"  width="280" height="190" alt="Bikers Club" title="Bikers Club"></a>
