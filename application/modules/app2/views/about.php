			<div class="contents">  <!-- start of content -->
				...
				<ul class="aboutus">
					<li>
						<a href=""><img src=<?php echo base_url();?>assets/images/about-biker.jpg"  width="450" height="299" alt="Bikers Club" title="Bikers Club"></a>
					</li>
					<li>
							<a href=""><img src="<?php echo base_url();?>assets/images/about-bikers.jpg" width="450" height="299" alt="Bikers Club" title="Bikers Club"></a>
					</li>
				</ul>	
